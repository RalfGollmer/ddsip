...
////////////////////
                                                ...
                                                if (i)
                                                {
                                                    ...
                                                    if (DDSIP_param->outlev)
                                                    {
                                                        fprintf (DDSIP_bb->moreoutfile," ##### adding cut %s  (infeas. scen %2d), violation %.14g, lhs= %.14g, min/max coeff %.6g/%.6g, #: %d rhs= %.14g ######n", rowstore, Bs+1, viol, lhs, min_entry, max_entry, icnt, rhs);
